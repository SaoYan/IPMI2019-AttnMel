...
def preprocess_data(root_dir):
    ...
    benign_seg    = glob.glob(os.path.join(root_dir, 'Val', 'benign', '*.png')); benign_seg.sort()
    malignant_seg = glob.glob(os.path.join(root_dir, 'Val', 'malignant', '*.png')); malignant_seg.sort()
